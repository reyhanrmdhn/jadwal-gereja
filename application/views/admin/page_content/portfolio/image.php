        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-wrapper">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <span class="m-portlet__head-icon">
                            <a href="javascript:void(0)" onclick="location.href='<?= base_url('admin-page/portfolio_detail/' . $id_portfolio) ?>'" style="text-decoration: none;">
                ...
                <div class="m-portlet__head-tools">
                    <a href="<?= base_url("admin-page/add-" . str_replace("_", "-", $tablename) . "/" . $id_portfolio . '/' . $id); ?>" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air mr-2">
                        <span>
                    ...
                    <?php if ($pages) { ?>
                        <?php foreach ($pages as $p) : ?>
                            <tr id="<?= $p->id ?>">
                                ...
                                <td>
                                    <a href="<?php echo site_url("admin-page/edit-" . str_replace("_", "-", $tablename)) . '/' . $id_portfolio . '/' . $id . '/' . $p->id ?>">
