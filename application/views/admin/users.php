<div class="m-content">
    ...
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile">
        ...
        <div class="m-portlet__body">
            ...
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="table_menuList">
                <thead>
                    <tr>
                    ...
                    <?php if ($pages) { ?>
                        <?php foreach ($pages as $p) : ?>
                            <tr id="<?= $p->id ?>">
                                ...
                                <td>
                                    <button class="btn btn-warning text-white" onclick="location.href='<?= base_url('admin-page/changepassword/' . $p->id) ?>'"><i class="fas fa-pencil-alt"></i>&nbsp;&nbsp;Change Password</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php } else {
