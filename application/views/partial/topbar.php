    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> <img src="<?= base_url('assets/') ?>images/church-logo.png" alt="church logo" class="img-responsive"></a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="<?= ($this->uri->segment(1) == '' || $this->uri->segment(1) == 'home') ? "active" : "" ?>"><a href="<?= base_url() ?>">Home</a></li>
                    <li class="<?= ($this->uri->segment(1) == 'about') ? "active" : "" ?>"><a href="about.html">About</a></li>
                    ...
                    <li class="<?= ($this->uri->segment(1) == 'contact') ? "active" : "" ?>"><a href="contact.html">CONTACT</a></li>
                </ul>
            </div>
